...
#define OVERHEAT_OVERRIDE   true    /* True = Overheating thermostat override */
...
void SerialTxNum(uint16_t, DigitLength);
...
void SetFlag(SysInfo *, FlagsByte, uint8_t, bool);
void ClearFlag(SysInfo *, FlagsByte, uint8_t, bool);
...
const char __flash str_error[] = {" >>> Error "};
...
const char __flash str_mode_30[] = {"  [ ON DHW DUTY ] .\n\r"};
const char __flash str_mode_40[] = {"   [ ON CH DUTY ] .\n\r"};
